...
export default function Hero() {
  return (
    <div className="flex flex-col items-center w-full sm:w-10/12 justify-center mt-5 md:mt-10">
        ...
        <motion.div initial={{opacity: 0}} animate={{opacity: 1}} transition={{delay: 1.3, duration: .3 }} href='#' className='text-white text-left mt-28 text-sm xs:text-lg max-w-[720px] w-10/12 mb-60 '>
