...
export default function Hero() {
  return (
    <div className="flex flex-col items-center justify-center mt-10">
        ...
        <motion.img initial={{opacity: 0}} animate={{opacity: 1}} transition={{delay: .8, duration: .3 }} className=" rounded-xl w-10/12 max-w-[700px]" layout='responsive' src='/sessi.jpg' ></motion.img>

        
        
        <motion.div initial={{opacity: 0}} animate={{opacity: 1}} transition={{delay: 1.1, duration: .3 }} href='#' className="flex flex-col items-center justif-center text-white font-[arial] tracking-[.3em] text-center mt-20 text-lg w-8/12 "><strong className='tracking-wide'></strong> 
        ...
        <div href='#' className='text-white text-center mt-60 text-lg w-10/12 mb-60 '>
...
<br/> <br/>Before all of this, Sessi graduated <i>cum</i> laude from Vassar College with degrees in philosophy and women’s studies.
